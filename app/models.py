...
class BusinessCardModel(Base):
    ...
    company_services_type = Column(String(), nullable=False)
    company_description = Column(Text, nullable=False)
    company_phone_number = Column(String(), nullable=False)
    company_instagram = Column(String(), default=None)
    company_telegram = Column(String(), default=None)
    company_address = Column(String(), nullable=False)
    company_website = Column(String(), default=None)
